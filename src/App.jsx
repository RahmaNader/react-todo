...
function App() {
  ...
  const [todos, setTodos] = useState([
    { input: 'Hello! Add your firs todo!', complete: false},
  ])
  const [selectedTab, setSelectedTab] = useState('Open')

  function handleAddTodo(newTodo) {
    //we add to the existing list but we create a new one a dublicate with the extra new todo at the end of the list 
    const newTodoList = [...todos, { input: newTodo, complete: false }]
    //now we use the hook to set the new to do to replace the old to do list
